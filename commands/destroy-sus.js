...
module.exports = {
  ...
  .setName("break_suspension_components")
  .setDescription("Returns what you would get after breaking down the amount of suspension components.")
  .addNumberOption(option =>
    option.setName("amount")
      .setDescription("The amount of suspension componets to break down.")
      .setRequired(true))
  ...
  async execute(interaction) {
    ...
    await interaction.editReply("Data not found, please provide <@!410248634593050627> with the breakdown.");
  }
}